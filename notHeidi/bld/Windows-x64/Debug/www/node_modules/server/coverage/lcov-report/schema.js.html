...
<html lang="en">
<head>
    <title>Code coverage report for schema.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> schema.js
    </h1>
    <div class='clearfix'>
...
module.exports = {
  ...
  public: {
    ...
    file: true,
    clean: (value, option) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (/^win/.test(process.platform) &amp;&amp; value === 'C:\\Users\\Public') {
        value = option.arg.public || option.def.default;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!value) return;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Jan 28 2018 17:34:33 GMT+0900 (JST)
</div>
</div>
