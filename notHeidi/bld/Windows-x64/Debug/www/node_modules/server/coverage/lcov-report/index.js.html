...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (is.boolean(env)) <span class="cstat-no" title="statement not covered" >env = typeof env === 'string' ? env === 'true' : env;</span>
      options[key] = env;
    }
  }
&nbsp;
...
&nbsp;
    ...
    for (let key in options) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (app.set &amp;&amp; ['boolean', 'number', 'string'].includes(typeof options[key])) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Feb 07 2017 17:57:32 GMT+0100 (CET)
</div>
</div>
