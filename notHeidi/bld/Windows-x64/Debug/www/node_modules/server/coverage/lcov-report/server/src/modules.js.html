...
<html lang="en">
<head>
    <title>Code coverage report for server/src/modules.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">server/src</a> modules.js
    </h1>
    <div class='clearfix'>
...
module.exports = {
  public: modernOps((path, self) =&gt; {
    ...
    throw self;
<span class="cstat-no" title="statement not covered" >    return self.express.static(path);</span>
  }),
...
&nbsp;
  ...
  session: modernOps(<span class="fstat-no" title="function not covered" >op</span>t =&gt; <span class="cstat-no" title="statement not covered" >opt &amp;&amp; opt.secret ? require('express-session')(opt) : false)</span>,
  favicon: modernOps(<span class="fstat-no" title="function not covered" >op</span>t =&gt; <span class="cstat-no" title="statement not covered" >opt ? require('serve-favicon')(opt) : false)</span>,
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Feb 07 2017 04:13:16 GMT+0100 (CET)
</div>
</div>
