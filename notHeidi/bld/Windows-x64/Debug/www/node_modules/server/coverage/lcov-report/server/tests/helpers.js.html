...
<html lang="en">
<head>
    <title>Code coverage report for server/tests/helpers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">server/tests</a> helpers.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const request = require('request-promises');
...
exports.err = <span class="fstat-no" title="function not covered" >ct</span>x =&gt; { <span class="cstat-no" title="statement not covered" >throw new Error('This should not be called'); </span>};
&nbsp;
&nbsp;
exports.launch = launch = (middle = <span class="branch-0 cbranch-no" title="branch not covered" >[],</span> opts = {}) =&gt; {
...
&nbsp;
exports.poster = (middle, data = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> opts) =&gt; exports.handler(post('/', middle), {
...
<span class="cstat-no" title="statement not covered" >      throw new Error('A non-error was thrown: ' + err);</span>
    }
    return err;
  }
<span class="cstat-no" title="statement not covered" >  throw new Error('No error was thrown');</span>
};
&nbsp;</pre></td></tr>
</table></pre>
