...
<html lang="en">
<head>
    <title>Code coverage report for server/plugins/connect/init.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">server/plugins/connect</a> init.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!path.isAbsolute(options.public)) {
...
&nbsp;
  // Public folder
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options.public) {
    connect.before.push(modern(ctx.express.static(options.public)));
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options.session) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (options.responseTime) {
