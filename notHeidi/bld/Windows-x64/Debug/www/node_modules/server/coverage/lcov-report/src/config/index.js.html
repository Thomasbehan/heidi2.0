...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/config</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  await Promise.all(plugins.map(<span class="fstat-no" title="function not covered" >as</span>ync ({ name, options: def = <span class="branch-0 cbranch-no" title="branch not covered" >{}}</span> = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
<span class="cstat-no" title="statement not covered" >    options[name] = await parse(def, user[name], env, options);</span>
  }));
&nbsp;
  // console.log(options);
&nbsp;
