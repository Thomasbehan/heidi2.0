...
<html lang="en">
<head>
    <title>Code coverage report for plugins/socket/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">plugins/socket</a> index.js
    </h1>
    <div class='clearfix'>
...
module.exports = {
  name: 'socket',
  options: {},
  router: <span class="fstat-no" title="function not covered" >(.</span>..all) =&gt; {
    const { path, middle } = <span class="cstat-no" title="statement not covered" >router.parse(all);</span>
<span class="cstat-no" title="statement not covered" >    console.log(path, middle);</span>
    // const [ path, middle ] = all;
    // listeners[path] = listeners[path] || [];
    // listeners[path].push(middle);
  },
  launch: <span class="fstat-no" title="function not covered" >ct</span>x =&gt; {
<span class="cstat-no" title="statement not covered" >    ctx.io = socketIO(ctx.server);</span>
<span class="cstat-no" title="statement not covered" >    ctx.io.on('connect', <span class="fstat-no" title="function not covered" >so</span>cket =&gt; {</span>
